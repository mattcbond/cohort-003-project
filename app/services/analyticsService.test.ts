...
describe("analyticsService", () => {
  ...
  describe("getAdminRevenueTimeSeries", () => {
    it("returns empty array for all-time period with no purchases", () => {
      const result = getAdminRevenueTimeSeries({ period: "all", now: NOW });
    ...
    it("uses daily buckets for 7d period", () => {
      ...
      const result = getAdminRevenueTimeSeries({ period: "7d", now: NOW });
    ...
    it("uses monthly buckets for 12mo period", () => {
      ...
      const result = getAdminRevenueTimeSeries({ period: "12mo", now: NOW });
